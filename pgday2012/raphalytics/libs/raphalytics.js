...
function raphalytics(paper,data,labels,tooltips,options)
{
    ...
    var width = options.width || 750,
        ...
        labelcolor = options.labelcolor || '#279dba',
        txt = {font: '12px HelveticaNeue-Light, Helvetica, Arial, sans-serif', fill: "#fff"},
        txt1 = {font: '10px HelveticaNeue-Light, Helvetica, Arial, sans-serif', fill: "#fff"},
        txt2 = {font: '12px HelveticaNeue-Light, Helvetica, Arial, sans-serif', fill: "#000"},
    ...
    label.hide();
    var frame = paper.popup(100, 100, label, "right").attr({fill: tooltipcolor, stroke: tooltipbordercolor, "stroke-width": 2, "fill-opacity": .7}).hide();
                ...
                (function (line, x, y, data, tooltip, dot)
                {
                    ...
                    rect.hover(
                        function ()
                        {
                            ...
                            var lx = label[0].transform()[0][1] + ppp.dx;
                            var ly = label[0].transform()[0][2] + ppp.dy;
